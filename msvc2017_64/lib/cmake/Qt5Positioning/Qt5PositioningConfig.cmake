...
set(Qt5Positioning_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::Positioning)
    ...
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.14.1"
        "${_qt5Positioning_install_prefix}/include/QtPositioning/5.14.1/QtPositioning"
    )
    ...
    foreach(_module_dep ${_Qt5Positioning_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5Positioning_FIND_VERSION_EXACT}
