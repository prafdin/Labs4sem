...
set(Qt5Sensors_VERSION_STRING 5.14.1)
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.14.1"
        "${_qt5Sensors_install_prefix}/include/QtSensors/5.14.1/QtSensors"
    )
    ...
    foreach(_module_dep ${_Qt5Sensors_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.14.1 ${_Qt5Sensors_FIND_VERSION_EXACT}
